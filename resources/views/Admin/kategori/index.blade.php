...
@section('content')
   ...
   <h2 class="py-1 mb-6 text-3xl font-bold text-center bg-white border border-blue-600 rounded-lg shadow-lg ">Halaman <u class="text-blue-600">Kategori</u></h2>
<a href="/admin/kategori/create" type="button" class="inline-block mt-3 px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Tambah Kategori</a>
          ...
          <table class="min-w-full text-center">
            <thead class="bg-blue-500 border-b">
              <tr>
                ...
                <th scope="col" class="h-10 px-6 py-4 text-sm font-medium text-white w-90 col-sm-3">
                  Nama Kategori
                </th>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 text-sm font-light text-gray-900 w-90 whitespace-nowrap col-sm-3">
                        {{ $kategori->nama }}
                    </td>
                    <td class="px-6 py-4 text-sm font-light text-gray-900 w-60 whitespace-nowrap col-sm-4">
                        <img src="{{ asset('storage/'.$kategori->gambar_kategori) }}" class="w-fit h-fit "> 
                    </td>
                    <td class="px-6 py-4 text-sm font-medium text-gray-900 justify-evenly whitespace-nowrap col-sm-3">
                        <a href="/admin/kategori/{{ $kategori->id }}/edit" data-mdb-ripple="true" data-mdb-ripple-color="light"
