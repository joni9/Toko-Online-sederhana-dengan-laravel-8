...
<div class="p-10 bg-white border-4 border-blue-500">
  ...
  <div class="flex justify-center">
    <h2 class="py-1 mb-12 text-3xl font-bold text-center bg-white border border-blue-600 rounded-lg shadow-lg w-80 ">Tambah <u class="text-blue-600">Slidder</u></h2>
  </div>

    <form action="/admin/slidder" method="post" enctype="multipart/form-data">
        @csrf
    <div class="flex justify-center mt-5">
        <div>
          ...
          <button type="submit" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Tambah slidder</button>
