...
<div class="p-5 bg-white border-4 border-blue-500 ">
    <a href="/admin/semua/pesanan" type="button" class="inline-block mt-3 px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Kembali</a>
  <div class="text-center">
    <h1 class="pb-6 text-3xl text-black">Halaman Edit Pesanan</h1>
  </div>

    <form action="/admin/semua/pesanan/edit/{{ $pesanan->id }}" method="post">
        @method('put')
        @csrf
