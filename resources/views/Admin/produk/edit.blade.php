...
<div class="p-10 bg-white border-4 border-blue-500">
  ...
  <div class="flex justify-center">
    <h2 class="py-1 mb-12 text-3xl font-bold text-center bg-white border border-blue-600 rounded-lg shadow-lg w-80 ">Edit <u class="text-blue-600">Produk</u></h2>
  </div>
    ...
    <div>
      ...
      <div class="mb-3 xl:w-120">
        <label for="exampleFormControlInpu3" class="inline-block mb-2 text-gray-700 form-label"
          > <strong>Nama Produk</strong> </label
        >
        <input
          name="nama"
      ...
      <div class="mb-3 xl:w-120">
        <label for="exampleFormControlInpu3" class="inline-block mb-2 text-gray-700 form-label"
          ><strong>Harga Produk</strong></label
        >
        <input
          name="harga"
      ...
      <div class="mb-3 xl:w-120">
        <label for="exampleFormControlInpu3" class="inline-block mb-2 text-gray-700 form-label"
          ><strong>Jumlah Stok</strong> </label
        >
        <input
          name="stok"
      ...
      <div class="mb-3 xl:w-120">
        <label for="formFileSm" class="inline-block mb-2 text-gray-700 form-label"><strong>Gambar Produk</strong></label>
        <input type="hidden" name="oldImage" value="{{ $produk->gambar_produk }}">
        @if ($produk->gambar_produk)
        <img src="{{ asset('storage/'.$produk->gambar_produk) }}" class="mb-3 img-fluid col-sm-5">
        @else
      ...
      <div class="mb-3 xl:w-120">
        <label for="exampleFormControlInpu3" class="inline-block mb-2 text-gray-700 form-label"
          ><strong>Keterangan</strong> </label
        >
        <input id="x" type="hidden" name="keterangan" value="{{ old('keterangan',$produk->keterangan) }}" @error('nama') is-invalid @enderror>
      ...
      <button type="submit" class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Update Produk</button>
    </div>
  </div>
</div>
</form>
