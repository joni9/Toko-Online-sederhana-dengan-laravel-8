<footer class="mt-5 text-center text-gray-600 bg-white lg:text-left">
    ...
    <div class="p-6 text-center text-white bg-gradient-to-t from-blue-400 via-blue-700 to-blue-600">
      <span>© 2023 Copyright <b>Joni Evendi</b></span>
